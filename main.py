...
def start(message):
    ...
    butteon = types.InlineKeyboardButton("مطور البوت", url="https://t.me/KOK0KK")
    buttoon = types.InlineKeyboardButton("قناة البوت", url="https://t.me/K_OK0KK")
    private.add(button)
    private.add(butteon,buttoon)   
    bot.send_photo(message.chat.id,"https://t.me/ZERO_R7K/389",caption="""
...
def tylaoa(call):
    if call.data == "quran":
        voices = "https://t.me/s_h_5a/" + str(random.randint(7, 276))
...
def tylaoa(call):
    if call.data == "kottab":
        voicess = "https://t.me/s_h_5a/" + str(random.randint(7, 265))
...
def tylaoa(call):
    if call.data == "nqsbndy":
        voicesss = "https://t.me/s_h_5a/" + str(random.randint(2, 114))
...
print("تم تشغيل البوت اذا وقف معك شي تواصل معي @KOK0KK")
